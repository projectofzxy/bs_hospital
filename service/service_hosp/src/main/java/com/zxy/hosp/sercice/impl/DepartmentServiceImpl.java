...
import com.zxy.hosp.repository.DepartmentRepository;
...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public void save(Map<String, Object> objectMap) {
        String toJSONString = JSONObject.toJSONString(objectMap);
        Department department= JSONObject.parseObject(toJSONString,Department.class);
        Department departmentExist=departmentRepository.getDepartmentByHoscodeAndDepcode(department.getHoscode(),department.getDepcode());
        if (departmentExist!=null){
            departmentExist.setIntro(department.getIntro());
            departmentExist.setBigcode(department.getBigcode());
            departmentExist.setBigname(department.getBigname());
    ...
    public List<DepartmentVo> findDeptTree(String hoscode) {
        ...
        Map<String, List<Department>> deparmentMap = departmentList
